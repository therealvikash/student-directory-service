        ...
        stage("Docker Image") {
            steps {
                script {
                    ...
                    sh 'sudo docker image tag $JOB_NAME:v1.$BUILD_ID therealvikash/$JOB_NAME:v1.$BUILD_ID'
                    sh 'sudo docker image tag $JOB_NAME:v1.$BUILD_ID therealvikash/$JOB_NAME:latest'
                }
            }
        }
